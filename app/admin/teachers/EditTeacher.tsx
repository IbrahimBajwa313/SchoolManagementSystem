...
export default function EditTeacher({ isOpen, onClose, onSuccess, teacher }: EditTeacherProps) {
  ...
  useEffect(() => {
    if (teacher && isOpen) {
      setFormData({
        ...
        experienceYears: teacher.experienceYears || teacher.totalExperience || 0,
        salary: teacher.salary || 0,
        joiningDate: teacher.joiningDate ? teacher.joiningDate.split('T')[0] : new Date().toISOString().split('T')[0],
        status: teacher.status,
        philosophy: teacher.philosophy || teacher.teachingPhilosophy || "",
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-blue-700">Edit Teacher</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-purple-900">Skills & Proficiency</h3>
